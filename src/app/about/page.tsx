    ...
    <div className="min-h-screen relative overflow-hidden bg-[#0a1128] text-slate-100">
      ...
      <main className="relative z-10 container mx-auto px-8 md:px-16 pt-16 pb-24 max-w-6xl">
        ...
        >
          ...
          <p>
            Throughout my academic journey, I&apos;ve gained hands-on experience with front-end development such as HTML, CSS, JavaScript, and React, while also exploring UX design and research. I enjoy prototyping with Figma and translating ideas into responsive, accessible applications. For me, every project is more than just development; it&apos;s a chance to solve problems thoughtfully and create experiences that are both beautiful and intelligent.
          </p>
          <p>
          ...
          <p>
            I&apos;m a lifelong learner, always experimenting with new frameworks and exploring ways to design solutions that are practical and human-centered. I&apos;ve integrated AI into my product development workflow to keep pace with industry shifts, boost efficiency, and spark innovation. Currently, I serve as a UX research assistant, contributing to a project that examines Generative AI and its environmental impacts.
          </p>
          <p>
